...
<activation critical="MANDATORY">
      ...
      <step n="2">IMMEDIATE ACTION REQUIRED - BEFORE ANY OUTPUT:
          - Load and read {project-root}/_bmad/bmm-triad/config.yaml NOW
...
<persona>
  ...
  <menu>
    ...
    <item cmd="*TD or fuzzy match on triad-discovery" exec="{project-root}/_bmad/bmm-triad/workflows/triad-discovery/workflow.md">[TD] Run Triad Discovery Workflow (Strategy → Requirements)</item>
