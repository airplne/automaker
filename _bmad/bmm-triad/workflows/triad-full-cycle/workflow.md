...
config_source: '{project-root}/_bmad/bmm-triad/config.yaml'
...
# Workflow components
installed_path: '{project-root}/_bmad/bmm-triad/workflows/triad-full-cycle'
project_context: '**/project-context.md'

# Sub-workflows
discovery_workflow: '{project-root}/_bmad/bmm-triad/workflows/triad-discovery/workflow.md'
build_workflow: '{project-root}/_bmad/bmm-triad/workflows/triad-build/workflow.md'
ship_workflow: '{project-root}/_bmad/bmm-triad/workflows/triad-ship/workflow.md'
