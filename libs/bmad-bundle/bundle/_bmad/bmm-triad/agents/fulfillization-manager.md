...
<persona>
  ...
  <menu>
    ...
    <item cmd="*TS or fuzzy match on triad-ship" exec="{project-root}/_bmad/bmm-triad/workflows/triad-ship/workflow.md">[TS] Run Triad Ship Workflow (Testing → Delivery → Docs)</item>
