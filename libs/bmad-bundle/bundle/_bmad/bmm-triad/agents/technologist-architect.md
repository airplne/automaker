...
<persona>
  ...
  <menu>
    ...
    <item cmd="*TB or fuzzy match on triad-build" exec="{project-root}/_bmad/bmm-triad/workflows/triad-build/workflow.md">[TB] Run Triad Build Workflow (Architecture → Implementation)</item>
